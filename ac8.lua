...
-- УЛУЧШЕННАЯ функция загрузки базы знаний (без логов ошибок)
...
-- УЛУЧШЕННАЯ функция сохранения базы знаний (без логов)
...
local function mainMenu()
    while running do
        ...
        print("⚡ Процессоры: " .. (meKnowledge.cpus and #meKnowledge.cpus or 0) .. " шт.")
